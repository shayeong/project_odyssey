...
public class Utility {
	...
	public static String saveFileSpring(MultipartFile mf, String basePath) {
		...
		String filename = "";
		long filesize = mf.getSize(); //c:/test/ai/ai.txt,(0)ai.txt,(1)ai.txt ....
	...
	public static String paging2(int total, int nowPage, int recordPerPage, String col, 
		      String word, String url) {
		    ...
		    if (nowGrp >= 2) {
		      str.append("<li class='page-item'><a class='page-link' href='" + url + "&col=" + col + "&word=" + word
		          + "&nowPage=" + nowPage + "&npage=" + _nowPage  + "'>이전</A></li>");
		    }
		    ...
		    for (int i = startPage; i <= endPage; i++) {
		      ...
		      if (nowPage == i) {
		        ...
		        str.append("<li class='page-item'><a class='page-link' href='" + url + "&col=" + col + "&word=" + word
		            + "&nowPage=" + nowPage + "&nPage=" + i + "'>" + i + "</A></li>");
		      }
		    }
		    ...
		    if (nowGrp < totalGrp) {
		      str.append("<li class='page-item'><a class='page-link' href='" + url + "&col=" + col + "&word=" + word
		          + "&nowPage=" + nowPage + "&npage=" + _nowPage +  "'>다음</A></li>");
		    }
		    str.append("</ul>");
		    str.append("</div>");
